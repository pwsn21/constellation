<template>
    <div class="full-width">
        <q-expansion-item label="Cohorts" class="text-h5 text-primary" header-class="q-pa-none" header-style="bg-white"
            ...
            <div>
                <q-table :rows="cohorts" row-key="id" :columns="cohortColumns" title-class="text-h4" :filter="filterCohort"
                    table-header-class="bg-primary text-white" dense
                    ...
                    <template v-slot:body="props">
                        <q-tr :props="props">
                            ...
                            <q-td key="status" :props="props">
                                <q-chip v-if="props.row.status === 'Active'" dense class="bg-green-10 text-white" clickable>
                                    {{ props.row.status }}
                                </q-chip>
